...
export const isNumber = (variable: any): variable is number => typeof variable === 'number'
...
export const getCleanCase = (string?: string): string => {
  if (!isString(string)) {
    return ''
  }
...
export const copyToClipboard = (value: string) => {
  ...
  // toastSuccess({ title: value + ' Copied to clipboard' })
}
